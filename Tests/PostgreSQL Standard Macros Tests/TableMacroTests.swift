    ...
    @Suite struct TableMacroTests {
        @Test func basics() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let bar = Structured_Queries._TableColumn<QueryValue, Int>.for("bar", keyPath: \QueryValue.bar)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.bar._allColumns)
                      return allColumns
                    }
                    public static var writableColumns: [any Structured_Queries.WritableTableColumnExpression] {
                      var writableColumns: [any Structured_Queries.WritableTableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    public typealias QueryValue = Foo
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      bar: some Structured_Queries.QueryExpression<Int>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension Foo: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  ...
                  public nonisolated init(decoder: inout some Structured_Queries.QueryDecoder) throws {
                    let bar = try decoder.decode(Int.self)
                    guard let bar else {
                      throw Structured_Queries.QueryDecodingError.missingRequiredColumn
                    }
                    self.bar = bar
                  }
                }
        ...
        @Test func selection() {
            assertMacro {
                ...
                nonisolated extension Foo: Structured_Queries.Table, Structured_Queries._Selection, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
        ...
        @Test func comment() {
            assertMacro {
                ...
                struct User {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    public typealias QueryValue = User
                    public typealias PrimaryKey = Int
                    public let id = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let email = Structured_Queries._TableColumn<QueryValue, String?>.for("email", keyPath: \QueryValue.email, default: "")
                    public let age = Structured_Queries._TableColumn<QueryValue, Int>.for("age", keyPath: \QueryValue.age)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<Int>,
                      email: some Structured_Queries.QueryExpression<String?> = String?(queryOutput: ""),
                      age: some Structured_Queries.QueryExpression<Int>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      ...
                      public let id = Structured_Queries._TableColumn<QueryValue, Int?>.for("id", keyPath: \QueryValue.id, default: nil)
                      public let email = Structured_Queries._TableColumn<QueryValue, String?>.for("email", keyPath: \QueryValue.email, default: "")
                      public let age = Structured_Queries._TableColumn<QueryValue, Int>.for("age", keyPath: \QueryValue.age)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<Int?> = Int?(queryOutput: nil),
                        email: some Structured_Queries.QueryExpression<String?> = String?(queryOutput: ""),
                        age: some Structured_Queries.QueryExpression<Int>
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension User: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct Bar {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    ...
                    public let baz = Structured_Queries._TableColumn<QueryValue, Int>.for("baz", keyPath: \QueryValue.baz)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      baz: some Structured_Queries.QueryExpression<Int>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension Bar: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
        ...
        @Test func literals() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let c1 = Structured_Queries._TableColumn<QueryValue, Swift.Bool>.for("c1", keyPath: \QueryValue.c1, default: true)
                    public let c2 = Structured_Queries._TableColumn<QueryValue, Swift.Int>.for("c2", keyPath: \QueryValue.c2, default: 1)
                    public let c3 = Structured_Queries._TableColumn<QueryValue, Swift.Double>.for("c3", keyPath: \QueryValue.c3, default: 1.2)
                    public let c4 = Structured_Queries._TableColumn<QueryValue, Swift.String>.for("c4", keyPath: \QueryValue.c4, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      c1: some Structured_Queries.QueryExpression<Swift.Bool> = Swift.Bool(queryOutput: true),
                      c2: some Structured_Queries.QueryExpression<Swift.Int> = Swift.Int(queryOutput: 1),
                      c3: some Structured_Queries.QueryExpression<Swift.Double> = Swift.Double(queryOutput: 1.2),
                      c4: some Structured_Queries.QueryExpression<Swift.String> = Swift.String(queryOutput: "")
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
        ...
        @Test func columnName() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let bar = Structured_Queries.TableColumn<QueryValue, Int>("Bar", keyPath: \QueryValue.bar)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.bar._allColumns)
                      return allColumns
        ...
        @Test func representable() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let bar = Structured_Queries.TableColumn<QueryValue, Date.UnixTimeRepresentation>("bar", keyPath: \QueryValue.bar)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.bar._allColumns)
                      return allColumns
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      bar: some Structured_Queries.QueryExpression<Date.UnixTimeRepresentation>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: bar._allColumns)
                      self.allColumns = allColumns
        ...
        @Test func columnGenerated() throws {
            assertMacro {
                ...
                struct User {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = User
                    public let name = Structured_Queries._TableColumn<QueryValue, String>.for("name", keyPath: \QueryValue.name)
                    public let generated = Structured_Queries.GeneratedColumn<QueryValue, String>("generated", keyPath: \QueryValue.generated)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      name: some Structured_Queries.QueryExpression<String>,
                      generated: some Structured_Queries.QueryExpression<String>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension User: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct User {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let name = Structured_Queries._TableColumn<QueryValue, String>.for("name", keyPath: \QueryValue.name)
                    public let generated = Structured_Queries.GeneratedColumn<QueryValue, Int>("generated", keyPath: \QueryValue.generated)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                      allColumns.append(contentsOf: QueryValue.columns.name._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public init(
                      id: some Structured_Queries.QueryExpression<Int>,
                      name: some Structured_Queries.QueryExpression<String>,
                      generated: some Structured_Queries.QueryExpression<Int>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                      allColumns.append(contentsOf: name._allColumns)
        ...
        @Test func capitalSelf() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let bar = Structured_Queries._TableColumn<QueryValue, ID<Foo>>.for("bar", keyPath: \QueryValue.bar)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.bar._allColumns)
                      return allColumns
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      bar: some Structured_Queries.QueryExpression<ID<Foo>>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: bar._allColumns)
                      self.allColumns = allColumns
        ...
        @Test func capitalSelfDefault() {
            assertMacro {
                ...
                struct Foo {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Foo
                    public let bar = Structured_Queries._TableColumn<QueryValue, _>.for("bar", keyPath: \QueryValue.bar, default: ID<Foo>())
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.bar._allColumns)
                      return allColumns
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      bar: some Structured_Queries.QueryExpression
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: bar._allColumns)
                      self.allColumns = allColumns
            ...
            assertMacro {
                ...
                struct User {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries.TableColumn<QueryValue, ID<User, UUID.BytesRepresentation>>("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries.TableColumn<QueryValue, ID<User, UUID.BytesRepresentation>>("id", keyPath: \QueryValue.id)
                    public let referrerID = Structured_Queries.TableColumn<QueryValue, ID<User, UUID.BytesRepresentation>?>("referrerID", keyPath: \QueryValue.referrerID, default: nil)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<ID<User, UUID.BytesRepresentation>>,
                      referrerID: some Structured_Queries.QueryExpression<ID<User, UUID.BytesRepresentation>?> = ID<User, UUID.BytesRepresentation>?(queryOutput: nil)
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let id = Structured_Queries.TableColumn<QueryValue, ID<User, UUID.BytesRepresentation>?>("id", keyPath: \QueryValue.id, default: nil)
                      public let referrerID = Structured_Queries.TableColumn<QueryValue, ID<User, UUID.BytesRepresentation>?>("referrerID", keyPath: \QueryValue.referrerID, default: nil)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                        allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<ID<User, UUID.BytesRepresentation>?> = ID<User, UUID.BytesRepresentation>?(queryOutput: nil),
                        referrerID: some Structured_Queries.QueryExpression<ID<User, UUID.BytesRepresentation>?> = ID<User, UUID.BytesRepresentation>?(queryOutput: nil)
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                        allColumns.append(contentsOf: id._allColumns)
        ...
        @Test func ephemeralField() {
            assertMacro {
                ...
                nonisolated extension SyncUp: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
        ...
        @Test func ephemeralFieldPrimaryKeyedTable() {
            assertMacro {
                ...
                nonisolated extension SyncUp: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct SyncUp {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let seconds = Structured_Queries._TableColumn<QueryValue, <#Type#>>.for("seconds", keyPath: \QueryValue.seconds, default: 60 * 5)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public init(
                      id: some Structured_Queries.QueryExpression<Int>,
                      seconds: some Structured_Queries.QueryExpression<<#Type#>> = <#Type#>(queryOutput: 60 * 5)
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
            ...
            assertMacro {
                ...
                struct RemindersList: Hashable, Identifiable {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let color = Structured_Queries.TableColumn<QueryValue, Color.HexRepresentation>("color", keyPath: \QueryValue.color, default: Color(red: 0x4a / 255, green: 0x99 / 255, blue: 0xef / 255))
                    public let name = Structured_Queries._TableColumn<QueryValue, Swift.String>.for("name", keyPath: \QueryValue.name, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public init(
                      id: some Structured_Queries.QueryExpression<Int>,
                      color: some Structured_Queries.QueryExpression<Color.HexRepresentation> = Color.HexRepresentation(queryOutput: Color(red: 0x4a / 255, green: 0x99 / 255, blue: 0xef / 255)),
                      name: some Structured_Queries.QueryExpression<Swift.String> = Swift.String(queryOutput: "")
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                ...
                nonisolated extension RemindersList: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                enum Post {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    ...
                    public let photo = Structured_Queries.ColumnGroup<QueryValue, Photo?>(keyPath: \QueryValue.photo)
                    public let note = Structured_Queries._TableColumn<QueryValue, String?>.for("note", keyPath: \QueryValue.note, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public static func photo(
                      _ photo: some Structured_Queries.QueryExpression<Photo>
                    ) -> Self {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                    ...
                    public static func note(
                      _ note: some Structured_Queries.QueryExpression<String>
                    ) -> Self {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension Post: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
        ...
        @Test func enumDiagnostic() {
            assertMacro {
                ...
                enum Post {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Post
                    public let photo = Structured_Queries._TableColumn<QueryValue, Photo?>.for("photo", keyPath: \QueryValue.photo)
                    public let note = Structured_Queries._TableColumn<QueryValue, String?>.for("note", keyPath: \QueryValue.note, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.photo._allColumns)
            ...
            assertMacro {
                ...
                enum Post {
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public static func note(
                      text note: some Structured_Queries.QueryExpression<String>
                    ) -> Self {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: Photo?(queryOutput: nil)._allColumns)
                      allColumns.append(contentsOf: note._allColumns)
        ...
        @Test func enumCustomColumn() {
            assertMacro {
                ...
                enum Post {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Post
                    public let note = Structured_Queries.TableColumn<QueryValue, String?>("note_text", keyPath: \QueryValue.note, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.note._allColumns)
                      return allColumns
        ...
        @Test func enumCustomRepresentation() {
            assertMacro {
                ...
                enum Post {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                    public typealias QueryValue = Post
                    public let timestamp = Structured_Queries.TableColumn<QueryValue, Date.UnixTimeRepresentation?>("timestamp", keyPath: \QueryValue.timestamp)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public static func timestamp(
                      _ timestamp: some Structured_Queries.QueryExpression<Date.UnixTimeRepresentation>
                    ) -> Self {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
    ...
    @Suite struct PrimaryKeyTests {
        @Test func basics() {
            assertMacro {
                ...
                nonisolated extension Foo: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                extension Foo: StructuredQueries.Table {
                  ...
                  public struct Draft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let id = Structured_Queries.TableColumn<QueryValue, Int>("id", keyPath: \QueryValue.id)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                        allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                        return allColumns
                ...
                nonisolated extension Foo.Draft: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct Reminder {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int>.for("id", keyPath: \QueryValue.id)
                    public let title = Structured_Queries._TableColumn<QueryValue, Swift.String>.for("title", keyPath: \QueryValue.title, default: "")
                    public let date = Structured_Queries.TableColumn<QueryValue, Date.UnixTimeRepresentation?>("date", keyPath: \QueryValue.date, default: nil)
                    public let priority = Structured_Queries._TableColumn<QueryValue, Priority?>.for("priority", keyPath: \QueryValue.priority, default: nil)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public init(
                      id: some Structured_Queries.QueryExpression<Int>,
                      title: some Structured_Queries.QueryExpression<Swift.String> = Swift.String(queryOutput: ""),
                      date: some Structured_Queries.QueryExpression<Date.UnixTimeRepresentation?> = Date.UnixTimeRepresentation?(queryOutput: nil),
                      priority: some Structured_Queries.QueryExpression<Priority?> = Priority?(queryOutput: nil)
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                ...
                nonisolated extension Reminder: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct Reminder {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries.TableColumn<QueryValue, UUID.BytesRepresentation>("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries.TableColumn<QueryValue, UUID.BytesRepresentation>("id", keyPath: \QueryValue.id)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                      return allColumns
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<UUID.BytesRepresentation>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                      self.allColumns = allColumns
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let id = Structured_Queries.TableColumn<QueryValue, UUID.BytesRepresentation?>("id", keyPath: \QueryValue.id, default: nil)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                        allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                        return allColumns
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<UUID.BytesRepresentation?> = UUID.BytesRepresentation?(queryOutput: nil)
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                        allColumns.append(contentsOf: id._allColumns)
                        self.allColumns = allColumns
        ...
        @Test func turnOffPrimaryKey() {
            assertMacro {
                ...
                nonisolated extension Reminder: Structured_Queries.Table, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct Reminder {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public typealias PrimaryKey = Int?
                    public let id = Structured_Queries._TableColumn<QueryValue, Int?>.for("id", keyPath: \QueryValue.id, default: nil)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, Int?>.for("id", keyPath: \QueryValue.id, default: nil)
                    public let title = Structured_Queries._TableColumn<QueryValue, Swift.String>.for("title", keyPath: \QueryValue.title, default: "")
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
            ...
            assertMacro {
                ...
                private struct Row {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries._TableColumn<QueryValue, UUID>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, UUID>.for("id", keyPath: \QueryValue.id)
                    public let timestamps = Structured_Queries.ColumnGroup<QueryValue, Timestamps>(keyPath: \QueryValue.timestamps)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<UUID>,
                      timestamps: some Structured_Queries.QueryExpression<Timestamps>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let id = Structured_Queries._TableColumn<QueryValue, UUID?>.for("id", keyPath: \QueryValue.id, default: nil)
                      public let timestamps = Structured_Queries.ColumnGroup<QueryValue, Timestamps>(keyPath: \QueryValue.timestamps)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                        allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<UUID?> = UUID?(queryOutput: nil),
                        timestamps: some Structured_Queries.QueryExpression<Timestamps>
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                        allColumns.append(contentsOf: id._allColumns)
                ...
                nonisolated extension Row: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                struct ReminderTag: Identifiable {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries.ColumnGroup<QueryValue, ReminderTagID>(keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries.ColumnGroup<QueryValue, ReminderTagID>(keyPath: \QueryValue.id)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                      return allColumns
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<ReminderTagID>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                      self.allColumns = allColumns
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<ReminderTagID?> = ReminderTagID?(queryOutput: nil)
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                        allColumns.append(contentsOf: id._allColumns)
                        self.allColumns = allColumns
                ...
                nonisolated extension ReminderTag: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                private struct ReminderWithList {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let reminderID = Structured_Queries.TableColumn<QueryValue, Reminder.ID>("reminderID", keyPath: \QueryValue.reminderID)
                    public let primaryKey = Structured_Queries.TableColumn<QueryValue, Reminder.ID>("reminderID", keyPath: \QueryValue.reminderID)
                    public let reminderTitle = Structured_Queries._TableColumn<QueryValue, String>.for("reminderTitle", keyPath: \QueryValue.reminderTitle)
                    public let remindersListTitle = Structured_Queries._TableColumn<QueryValue, String>.for("remindersListTitle", keyPath: \QueryValue.remindersListTitle)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      reminderID: some Structured_Queries.QueryExpression<Reminder.ID>,
                      reminderTitle: some Structured_Queries.QueryExpression<String>,
                      remindersListTitle: some Structured_Queries.QueryExpression<String>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let reminderID = Structured_Queries.TableColumn<QueryValue, Reminder.ID?>("reminderID", keyPath: \QueryValue.reminderID, default: nil)
                      public let reminderTitle = Structured_Queries._TableColumn<QueryValue, String>.for("reminderTitle", keyPath: \QueryValue.reminderTitle)
                      public let remindersListTitle = Structured_Queries._TableColumn<QueryValue, String>.for("remindersListTitle", keyPath: \QueryValue.remindersListTitle)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        reminderID: some Structured_Queries.QueryExpression<Reminder.ID?> = Reminder.ID?(queryOutput: nil),
                        reminderTitle: some Structured_Queries.QueryExpression<String>,
                        remindersListTitle: some Structured_Queries.QueryExpression<String>
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                ...
                nonisolated extension ReminderWithList: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
            ...
            assertMacro {
                ...
                private struct Metadata: Identifiable {
                  ...
                  public nonisolated struct TableColumns: Structured_Queries.TableDefinition, Structured_Queries.PrimaryKeyedTableDefinition {
                    ...
                    public let id = Structured_Queries._TableColumn<QueryValue, MetadataID>.for("id", keyPath: \QueryValue.id)
                    public let primaryKey = Structured_Queries._TableColumn<QueryValue, MetadataID>.for("id", keyPath: \QueryValue.id)
                    public let userModificationDate = Structured_Queries._TableColumn<QueryValue, Date>.for("userModificationDate", keyPath: \QueryValue.userModificationDate)
                    public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                      var allColumns: [any Structured_Queries.TableColumnExpression] = []
                      allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                  ...
                  public nonisolated struct Selection: Structured_Queries.TableExpression {
                    ...
                    public let allColumns: [any Structured_Queries.QueryExpression]
                    public init(
                      id: some Structured_Queries.QueryExpression<MetadataID>,
                      userModificationDate: some Structured_Queries.QueryExpression<Date>
                    ) {
                      var allColumns: [any Structured_Queries.QueryExpression] = []
                      allColumns.append(contentsOf: id._allColumns)
                  ...
                  public struct Draft: Structured_Queries.TableDraft {
                    ...
                    public nonisolated struct TableColumns: Structured_Queries.TableDefinition {
                      public typealias QueryValue = Draft
                      public let id = Structured_Queries._TableColumn<QueryValue, MetadataID?>.for("id", keyPath: \QueryValue.id, default: nil)
                      public let userModificationDate = Structured_Queries._TableColumn<QueryValue, Date>.for("userModificationDate", keyPath: \QueryValue.userModificationDate)
                      public static var allColumns: [any Structured_Queries.TableColumnExpression] {
                        var allColumns: [any Structured_Queries.TableColumnExpression] = []
                        allColumns.append(contentsOf: QueryValue.columns.id._allColumns)
                    ...
                    public nonisolated struct Selection: Structured_Queries.TableExpression {
                      ...
                      public let allColumns: [any Structured_Queries.QueryExpression]
                      public init(
                        id: some Structured_Queries.QueryExpression<MetadataID?> = MetadataID?(queryOutput: nil),
                        userModificationDate: some Structured_Queries.QueryExpression<Date>
                      ) {
                        var allColumns: [any Structured_Queries.QueryExpression] = []
                        allColumns.append(contentsOf: id._allColumns)
                ...
                nonisolated extension Metadata: Structured_Queries.Table, Structured_Queries.PrimaryKeyedTable, Structured_Queries.PartialSelectStatement {
                  public typealias QueryValue = Self
                  public typealias From = Swift.Never
                  public nonisolated static var columns: TableColumns {
                    TableColumns()
